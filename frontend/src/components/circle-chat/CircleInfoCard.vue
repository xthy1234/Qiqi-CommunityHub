...
<template>
  <div class="circle-info-card">
    <div class="card-header">
      <n-avatar :src="circle?.avatar" round size="large" />
    ...
    <div class="card-content">
      ...
      <div class="info-section">
        ...
        <div class="section-value">
          <n-tag v-if="circle?.myRole === 'OWNER'" type="error" size="medium" bordered round>
            圈主
          </n-tag>
          <n-tag v-else-if="circle?.myRole === 'ADMIN'" type="warning" size="medium" bordered round>
            管理员
          </n-tag>
          <n-tag v-else type="default" size="medium" bordered round>
            成员
          </n-tag>
        </div>
      </div>
    ...
    <div class="card-actions">
      <n-button v-if="canManage" type="primary" block @click="handleSettings">
        圈子设置
      </n-button>
      <n-button v-else type="default" block secondary @click="handleLeave">
        退出圈子
      </n-button>
    </div>
  </div>
